  ...
  return (
    <section className="mx-auto mb-10 flex max-w-screen-xl flex-col gap-14 bg-white p-10  dark:bg-gray-900">
      ...
      <div className="flex items-center">
        <div className="max-w-screen-xl flex-col  items-start justify-start px-4 py-8  lg:py-16">
          <h1 className="mb-4 max-w-2xl text-2xl">WE ARE THE PEOPLE AND TEAM BEHIND {companyData.companyName}.</h1>
          <div className="flex flex-col self-end">
            <p className="mb-6 max-w-2xl text-sm font-light dark:text-gray-400 md:max-w-md">
              our mission is to {companyData.Mission}
            </p>
            <GetQuoteButton variant="outline" className="border-black text-black" buttonText="Suggest a Startup" />
          </div>
        </div>
